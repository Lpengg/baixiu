...
def upgrade():
    ...
    sa.Column('cate_name', sa.String(length=20), nullable=False),
    ...
    sa.Column('bio', sa.String(length=30), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('tags', sa.String(length=10), nullable=False),
